...
class DiskInspector {
    ...
    private func createDiskInfo() throws -> DiskInfo {
        ...
        guard let bsdName = diskDescription[kDADiskDescriptionMediaBSDNameKey] as? String else {
            throw DiskInspectorError.unableToRetrieveBSDName
        }
...
extension DiskInspector {
    ...
    static func getBSDDrivesNames() throws -> [String] {
        ...
        guard IOServiceGetMatchingServices(kIOMainPortDefault, matchingDictionary, &serviceIterator) == KERN_SUCCESS else {
